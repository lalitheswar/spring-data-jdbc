...
/**
 * Filtering {@link DelegatingVisitor visitor} applying a {@link Predicate filter}. Typically used as base class for {@link Visitor visitors} that wish to apply hierarchical processing based on a well-defined entry {@link Visitor segment}.
 * <p/>
...
abstract class FilteredSubtreeVisitor extends DelegatingVisitor {
	 ...
	 * @return
	 */
	DelegatingVisitor enterMatched(Visitable segment) {
		return this;
	}
